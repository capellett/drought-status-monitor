...
##### MONTHLY
outfile <- paste0('dukeScrape//', lake, '_level_monthly.html')

### Modify the phantom JS script
lines <- readLines("dukeScrape//duke_scrape_template_monthly.js")
lines[1] <- paste0("var url ='", url ,"';")
lines[2] <- paste0("var outfile = '", outfile, "';")
writeLines(lines, "dukeScrape//duke_scrape_monthly.js")
### Render and save the page using phantom JS
system("dukeScrape//phantomjs dukeScrape//duke_scrape_monthly.js")
...
################################ LAKE DATA2 ##################################
scrapeDukeLakeLevels_monthly <- function(
