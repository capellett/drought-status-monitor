...
Put the excel files for all wells in the vignettes folder. Only include excel files for the wells that we want to calculate statistics for. Otherwise, the other non required excel files would combine.
